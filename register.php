				...
				<div class="col-lg-5 col-md-6 col-sm-10 m-lr-auto">			
						...
						<div class="col-12 p-b-5">
							...
							<div class="password-container">
								<input type="password" name="password1" id="password1" class="size-111 bor8 stext-102 cl2 p-lr-20 password-input" minlength="6" maxlength="10" required>
								<i class="fa fa-eye-slash password-toggle" id="togglePassword1" onclick="togglePassword('password1', 'togglePassword1')"></i>
							</div>
						</div>
						...
						<div class="col-12 p-b-5">
							...
							<div class="password-container">
								<input type="password" name="password2" id="password2" class="size-111 bor8 stext-102 cl2 p-lr-20 password-input" minlength="6" maxlength="10" required>
								<i class="fa fa-eye-slash password-toggle" id="togglePassword2" onclick="togglePassword('password2', 'togglePassword2')"></i>
							</div>
						</div>
