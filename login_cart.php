				...
				<div class="col-lg-5 col-md-6 col-sm-10 m-lr-auto">
						...
						<div class="col-12 p-b-30">
							...
							<div class="password-container" style="position: relative;">
								<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="password" type="password" name="password" required>
								<i class="fa fa-eye-slash password-toggle" id="password-toggle" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #666;"></i>
							</div>
						</div>
